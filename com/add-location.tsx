  ...
  return (
    ...
    `}>
      ...
      <div className={Styles.addLocationMenu}>
        ...
        {/* Zip Code Form */}
        <form onSubmit={onZipCodeFormSubmit} className={Styles.addLocationForm}>
          <p className={Styles.addLocationFormText}>
            Use Zip Code
          </p>
        ...
        {/* Zip Code Form */}
        <form onSubmit={onCityFormSubmit} className={Styles.addLocationForm}>
          <p className={Styles.addLocationFormText}>
            Use City Name
          </p>
          <div className={Styles.addLocationFormContainer}>
